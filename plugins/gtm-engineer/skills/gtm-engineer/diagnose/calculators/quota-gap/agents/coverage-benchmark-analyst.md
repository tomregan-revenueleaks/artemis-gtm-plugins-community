...
- **Pipeline coverage**, median across a large body of B2B SaaS GTM audits is **1.8x** quarterly; best-in-class is **3-4x** (Winning by Design, Clari), but only meaningful relative to win rate (required = 1 ÷ win rate). A 40%-win-rate team needs ~2.5x; a 15%-win-rate team needs ~6.7x.
...
| Actual coverage | | required ×; median 1.8x across a large body of B2B SaaS GTM audits | grade A-F |
