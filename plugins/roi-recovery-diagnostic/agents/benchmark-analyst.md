...
Source: 2026 GTM Benchmark Study (127 B2B SaaS companies, $1M-$50M ARR). The top-quartile bars are exactly the calculator's default benchmarks. The median bars are the conservative reference. Deal size, monthly leads, AE count, and ARR are NOT benchmarked levers — they are volume/context inputs that scale the dollar figure, not gaps to recover; pass them through unscored.
